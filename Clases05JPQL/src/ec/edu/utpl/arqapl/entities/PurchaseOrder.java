...
package ec.edu.utpl.arqapl.entities;
...
@NamedQueries({
    ...
    @NamedQuery(name = "PurchaseOrder.getCostByCustomerId", query = "SELECT NEW ec.edu.utpl.arqapl.entities.views.CostoEnvio(p.customerId.name, SUM(p.shippingCost)) FROM PurchaseOrder p WHERE p.customerId.customerId = :customerId GROUP BY p.customerId.name")
})
public class PurchaseOrder implements Serializable {
    ...
    public String toString() {
        return "ec.edu.utpl.arqapl.entities.PurchaseOrder[ orderNum=" + orderNum + " ]";
    }
